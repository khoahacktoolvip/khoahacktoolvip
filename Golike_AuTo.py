...
#| Bản Quyền : NGUYỄN ĐĂNG KHOA
#|>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
#|THÔNG TIN LIÊN HỆ :
#|______________________________________________________________________________________________________________________________________________________________
#|[  Nguyễn Đăng Khoa 🎓]      [Facebook ☎️ : https://www.facebook.com/nguyen.ang.khoa.798421/  |  [Group 📢: https://www.facebook.com/groups/1138876097614502]
#|______________________________________________________________________________________________________________________________________________________________
#|>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
# ─────────── MAIN ─────────── #
